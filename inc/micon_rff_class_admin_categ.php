...
class MIconRffCateg{
    ...
    function openDivFormCateg(){
        echo '<div id="divFormRffCatAdmin" style="position:absolute;background-color:white;border:1px solid #cdcdcd;top:0;left:0;width:calc(100% - 40px);height:calc(100% - 40px);padding:20px;z-index:4;">
